...
#include "../../../dedup_mod_pybind/method/pdm.hpp"
...
BOOST_AUTO_TEST_CASE(Similarity) {
  ...
  std::vector<Stacktrace> pair1{{.report_idx = 6, .stack = {10, 9, 8, 5, 4, 3, 2, 1, 0, 42}},
                                {.report_idx = 7, .stack = {10, 9, 8, 7, 5, 4, 1, 0}}};
